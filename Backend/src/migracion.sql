...
CREATE TABLE [HistoryMedicaments] (
    ...
    CONSTRAINT [PK_HistoryMedicaments] PRIMARY KEY ([Id]),
...
(N'12e6b0e1-1eb6-4a4b-8b57-a7D9adT78sdf', 0, N'admin-concurrency-004', N'admin@mediagenda.com', CAST(1 AS bit), CAST(0 AS bit), NULL, N'Jhan Crhistian', N'admin@MEDIAGENDA.COM', NULL, N'AQAAAAIAAYagAAAAEMYtGJF/SM5CogXcBNxMt7wjuA8/1by854I67fOXznLB9REB7YSpdV6xE4RIs0Q8Eg==', N'8098876543', CAST(0 AS bit), N'ADMIN-SECURITY-STAMP-004', CAST(0 AS bit), NULL),
...
(N'admin-role-id', N'12e6b0e1-1eb6-4a4b-8b57-a7D9adT78sdf'),
...
CREATE INDEX [IX_HistoryMedicaments_PatientId] ON [HistoryMedicaments] ([PatientId]);
...
VALUES (N'20251216212139_initialmigration', N'10.0.2');
